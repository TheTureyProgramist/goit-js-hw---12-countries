...
let allCountries = [];
fetch("https://restcountries.com/v2/all?fields=name,flag,capital,population,languages").then((response)=>response.json()).then((data)=>{
    allCountries = data;
}).catch((error)=>{
...
catchCountry.addEventListener('input', ()=>{
    ...
    const filtered = allCountries.filter((country)=>country.name.toLowerCase().includes(searchText));
    ...
    if (filtered.length === 1) {
      ...
      <div style="width: 350px; gap: 60px; flex-direction: column; display: flex; ">
        ...
        <p style="width: 350px; font-size: 20px;">\u{421}\u{442}\u{43E}\u{43B}\u{438}\u{446}\u{44F}:${country.capital}</p>
        <p style="width: 350px; font-size: 20px;">\u{41D}\u{430}\u{441}\u{435}\u{43B}\u{435}\u{43D}\u{43D}\u{44F}:${country.population.toLocaleString()}</p>
        <p style="width: 350px; font-size: 20px;">\u{41C}\u{43E}\u{432}\u{438}:</strong> ${languages}</p>
      </div>
